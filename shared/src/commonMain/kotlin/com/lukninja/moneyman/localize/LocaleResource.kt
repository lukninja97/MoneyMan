...
import com.lukninja.moneyman.di.getKoinInstance
import com.lukninja.moneyman.localize.language.br.localizeStringCountryBR
import com.lukninja.moneyman.localize.language.en.localizeStringCountryEN
import com.lukninja.moneyman.localize.language.es.localizeStringCountryES
...
class LocaleResource(countryCode: String? = null, regionCode: String? = null) : KoinComponent {
    private val database: MoneyManDatabase by inject()
...
///instance provider
fun getLocaleResources(): LocaleResource = getKoinInstance()
